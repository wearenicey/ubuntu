			...
			<div class="mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
				<div class="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
					<h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
						...
						<span class="block text-indigo-600 xl:inline">a treba vam psihoterapeut? Ubuntu je pravi izbor</span>
					</h1>
		...
		<div class="bg-gray-50 my-14">
			<div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
                ...
                -->
							...
							<dd x-show="open" class="mt-2 pr-12" id="faq-0">
								<p class="text-base text-gray-500">Cena porodične psihoterapije</p>
							</dd>
						</div>
						<div x-data="{open: false}" class="pt-6">
							<dt class="text-lg">
			...
			<div>
				<div class="max-w-7xl mx-auto pb-10 px-4 sm:py-10 sm:px-6 lg:px-8">
					<div class="text-center">
						<h2 class="mt-1 text-3xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-5xl">Zakažite još danas svoj prvi razgovor sa psihoterapeutom</h2>
					...
					<div class="grid grid-cols-1 lg:grid-cols-3">
						...
						<div class="relative overflow-hidden bg-indigo-700">
							...
							<div class="py-10 px-6 sm:px-10 xl:p-12">
								...
								<p class="mt-6 text-base text-indigo-50 max-w-3xl">Ubuntu Beograd brine o vašem mentalnom zdravlju od 2019. godine</p>
