					...
					<div class="relative mt-12 sm:mt-16 lg:mt-24">
						<div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
							<div class="lg:col-start-2">
								...
								<p class="mt-3 text-lg text-gray-500">
									Kako bismo unapredili rad savetovališta i usluge koje pružamo, uveli smo psihološku procenu ličnosti i motivacije za rad pre početka samog psihoterapijskog rada. Testiranje se odvija onlajn, traje do 90 minuta i neophodno
									je izdvojiti 2.000 rsd, koji predstavljaju svojevrsnu pristupnu članarinu.
								</p>
								<p class="mt-3 text-lg text-gray-500">
						...
						<div class="grid grid-cols-1 lg:grid-cols-3">
							...
							<div class="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
								...
								<p class="mt-6 text-base text-indigo-50 max-w-3xl">
									Uočili smo da postoji velika potreba za psihološkom podrškom ljudi koji nisu u velikim gradovima ili su van svoje matične zemlje. Bez obzira na to gde se nalazite, mi se brinemo za to da dobijete psihološku podršku koja
									vam je potrebna.
								</p>
