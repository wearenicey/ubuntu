			...
			<div>
				<div class="max-w-7xl mx-auto pb-10 px-4 sm:py-10 sm:px-6 lg:px-8">
					<div class="text-center">
						<h1 class="mt-1 text-3xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-5xl">Razgovor sa psihoterapeutom</h1>
					...
					<div class="grid grid-cols-1 lg:grid-cols-3">
						...
						<div class="relative overflow-hidden bg-indigo-700">
							...
							<div class="py-10 px-6 sm:px-10 xl:p-12">
								...
								<p class="mt-6 text-base text-indigo-50 text-2xl max-w-3xl">Novi Sad</p>
								<dl class="mt-6 space-y-6">
									...
									<dd class="flex text-base text-indigo-50">
										...
										<span class="ml-3"> <a href="tel:+381658286883">0658286881 </a></span>
									</dd>
								...
								<p class="mt-6 text-base text-indigo-50 text-2xl max-w-3xl">Beograd</p>
								<dl class="mt-6 space-y-6">
									<dt><span class="sr-only">Telefon</span></dt>
									<dd class="flex text-base text-indigo-50">
										<!-- Heroicon name: outline/phone -->
