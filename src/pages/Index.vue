				...
				<div class="py-12 px-4 border-t-2 border-gray-200 sm:px-6 md:py-16 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16">
					...
					<blockquote class="mt-6 md:flex-grow md:flex md:flex-col">
						<div class="relative text-lg font-medium text-gray-900 md:flex-grow">
							...
							<p class="relative">
								Milica mi je pomogla da osvestim, shvatim i prihvatim svoje postupke i ponašanje. Neprocenjivo je kada možeš da kažeš stvari koje nikome nisi izgovorio i da dobiješ razumevanje i podršku.
							</p>
						</div>
						<footer class="mt-8">
							<div class="flex items-start">
