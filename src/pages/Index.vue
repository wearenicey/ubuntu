				...
				<div class="text-center">
					...
					<div class="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center gap-x-4">
							...
							<div class="space-y-4 sm:space-y-0 sm:mx-auto sm:gap-5 justify-center flex">
								<a href="#3-polja" class="items-center justify-center px-5 py-4 border border-transparent text-lg font-medium rounded-full shadow-sm text-white bg-secondary hover:bg-gray-200 hover:text-secondary sm:px-8">
									Kako započeti?
								</a>
							</div>
		...
		<div class="mt-20">
			<div class="relative pb-32 bg-gray-800">
				...
				<div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
					...
					<p id="3-polja" class="mt-6 max-w-3xl text-xl text-white">
