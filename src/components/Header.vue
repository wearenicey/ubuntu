          ...
          -->
            ...
            -->
						...
						>
							<div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
								<div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
									<a href="/prokrastinacija" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
									...
									<a href="/anksioznost" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
									...
									<a href="/psihoterapija" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
